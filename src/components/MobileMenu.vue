...
<template>
  <aside class="category-sidebar">
    <div class="category-header">
      ...
      <button class="category-close" @click="closeCategoryModal"><i class="icofont-close"></i></button>
    </div>
  ...
  <aside class="nav-sidebar">
    <div class="nav-header">
      ...
      <button class="nav-close" @click="mobileMenuModalClose"><i
  ...
  <div class="mobile-menu">
    <router-link :to="{name:'frontend.home'}" class="active router-link-exact-active" title="Home Page" aria-current="page"><i
        class="fas fa-home"></i><span>Home</span></router-link>

    <button class="cate-btn" @click="openCategoryModal" title="Category List">
      <i class="fas fa-list"></i><span>category</span>
    </button>
    <!-- Cart Open button  -->
    <button class="cart-btn" title="Cartlist" @click="cartModalOpen">
