...
<template>
  <aside class="cart-sidebar">
    <div class="cart-header">
      ...
      <!-- Cart Close BTN -->
      <button class="cart-close" @click="cartModalClose"><i class="icofont-close"></i></button>
    </div>
    <ul class="cart-list">
      <li class="cart-item">
    ...
    <div class="cart-footer">
      <!-- -------------coupon btn ------------------->
      <button class="coupon-btn" @click="couponModalOpen">Do you have a coupon code?</button>
